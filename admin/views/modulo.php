                ...
                <section class="content">
                    ...
                    if ($vars["formularioNuevo"]) {
                            ...
                            <div class="box box-primary">
                                ...
                                <form class="form-validar form-horizontal" action="index.php?controlador=<?php echo $controlador; ?>&accion=<?php echo $vars["accion"]; ?>Registro" method="post" class="formvalidar" enctype="multipart/form-data">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label" for="nombre">Nombre (Seguridad Modulos)</label>
                                            <div class="col-sm-10">
                                                <?php $vars["formXhtml"]->inputtext("text", "pagina", "pagina", $vars["arrayRegistro"]["pagina"], "validar form-control", "Pagina (Seguridad Modulos)"); ?>
                                            </div>
                                        </div>
                                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Modulos registrados en el Sistema</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                            ...
                                            foreach($vars["arrayPaginador"] as $item) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        if ($item["activo"]) {
                                                            ?>
                                                            <a href="index.php?controlador=<?php echo $controlador; ?>&accion=modulo&id=<?php echo $item['id']; ?>&a=0"><span class="fa fa-plus-circle"/></a>
                                                            <?php
                                                        } else {
                                                            ?>
                                                            <a href="index.php?controlador=<?php echo $controlador; ?>&accion=modulo&id=<?php echo $item['id']; ?>&a=1"><span class="fa fa-times"/></a>
                                                            <?php
                                                        }
                                                        ?>
                                                    </td>
