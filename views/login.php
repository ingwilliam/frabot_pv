                        ...
                        <div class="page-login">
                            ...
                            <div class="account-border">
                                <div class="row">
                                    ...
                                    <form action="index.php?controlador=Index&accion=autenticar" method="post" enctype="multipart/form-data">                                        
                                        <div class="col-sm-6 customer-login">                                                                                        
                                            <div class="well">
                                                <h2><i class="fa fa-file-text-o" aria-hidden="true"></i> Yo soy cliente</h2>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" name="clave" value="" id="input-password" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="bottom-form">
                                                <a href="index.php?controlador=Index&accion=recordar" class="forgot">Contraseña olvidada</a>
