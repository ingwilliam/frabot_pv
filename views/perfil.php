            ...
            <div class="main-container container">
                ...
                <div class="row">
                    ...
                    <div id="content" class="col-sm-12">                        
                        ...
                        <form action="index.php?controlador=Index&accion=perfil" method="post" enctype="multipart/form-data" class="form-horizontal account-register clearfix form-validar">
                            ...
                            <fieldset id="account">
                                ...
                                <div class="form-group required">
                                    ...
                                    <div class="col-sm-10">
                                        <?php echo $vars["arrayRegistro"]["usuario"]; ?>
                                    </div>
                                </div>
                                <div class="form-group required">
